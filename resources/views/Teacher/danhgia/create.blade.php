    ...
    <div class="col-12">
        <div class="card mb-4 shadow-sm">
            <div class="card-header bg-primary text-white">
                <h6 class="m-0 font-weight-bold"><i class="fas fa-star"></i> Thêm đánh giá học sinh</h6>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('teacher.danhgia.store') }}" method="POST" id="danhgiaForm">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="mahocsinh" id="mahocsinh" class="form-control" required>
                                ...
                                @foreach ($hocsinh as $hs)
                                    <option value="{{ $hs->id }}"
                                        {{ old('mahocsinh', request('mahocsinh')) == $hs->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" name="nam" id="nam" class="form-control" min="2000"
                                max="2100" value="{{ old('nam', date('Y')) }}" required>
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="nhanxetchung" id="nhanxetchung" rows="4" class="form-control"
                                placeholder="Nhập nhận xét về học sinh...">{{ old('nhanxetchung') }}</textarea>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            ratingContainers.forEach(container => {
                ...
                // Hiển thị rating ban đầu (nếu có old value)
