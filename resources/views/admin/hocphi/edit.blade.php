...
@section('content')
    <div class="container-fluid" id="container-wrapper">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Chỉnh sửa học phí</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-10 mx-auto mb-4">
                <div class="card shadow-lg border-0 rounded-lg">
                    <div class="card-header bg-primary text-white">
                        <h6 class="m-0 font-weight-bold"><i class="fas fa-wallet"></i> Chỉnh sửa thông tin học phí</h6>
                    </div>
                    <div class="card-body p-4">
                        <form action="{{ route('admin.hocphi.update', $hocphi->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="mahocsinh" id="mahocsinh" class="form-control" required>
                                        ...
                                        @foreach ($hocsinh as $hs)
                                            <option value="{{ $hs->id }}"
                                                {{ $hocphi->mahocsinh == $hs->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" name="thoigiandong" id="thoigiandong" class="form-control"
                                        value="{{ old('thoigiandong', $hocphi->thoigiandong ? \Carbon\Carbon::parse($hocphi->thoigiandong)->format('Y-m-d') : '') }}"
                                        required>
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" step="0.01" name="hocphi" id="hocphi" class="form-control"
                                        value="{{ old('hocphi', $hocphi->hocphi ?? 0) }}">
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" step="0.01" name="phikhac" id="phikhac" class="form-control"
                                        value="{{ old('phikhac', $hocphi->phikhac ?? 0) }}">
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="date" name="ngaythanhtoan" id="ngaythanhtoan" class="form-control"
                                        value="{{ old('ngaythanhtoan', $hocphi->ngaythanhtoan ? \Carbon\Carbon::parse($hocphi->ngaythanhtoan)->format('Y-m-d') : '') }}">
                                </div>
                                {{-- Đã thanh toán --}}
                                <div class="col-md-3 mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="magiaovien" id="magiaovien" class="form-control" required>
                                        ...
                                        @foreach ($giaovien as $gv)
                                            <option value="{{ $gv->id }}"
                                                {{ $hocphi->magiaovien == $gv->id ? 'selected' : '' }}>
                                                {{ $gv->tengiaovien }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-8 mb-3">
                                    ...
                                    <textarea name="ghichu" id="ghichu" rows="2" class="form-control">{{ old('ghichu', $hocphi->ghichu) }}</textarea>
                                </div>
