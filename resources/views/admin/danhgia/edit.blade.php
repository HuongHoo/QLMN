...
@section('content')
    <div class="container-fluid" id="container-wrapper">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Chỉnh sửa đánh giá</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-10 mb-4 mx-auto">
                <div class="card shadow-lg border-0 rounded-lg">
                    <div class="card-header bg-primary text-white">
                        <h6 class="m-0 font-weight-bold"><i class="fas fa-edit"></i> Chỉnh sửa thông tin đánh giá</h6>
                    </div>
                    <div class="card-body p-4">
                        <form action="{{ route('admin.danhgia.update', $danhgia->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="magiaovien" id="magiaovien" class="form-control" required>
                                        ...
                                        @foreach ($giaovien as $gv)
                                            <option value="{{ $gv->id }}"
                                                {{ old('magiaovien', $danhgia->magiaovien) == $gv->id ? 'selected' : '' }}>
                                                {{ $gv->tengiaovien }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="nhanxetchung" id="nhanxetchung" rows="3" class="form-control">{{ old('nhanxetchung', $danhgia->nhanxetchung) }}</textarea>
                                </div>
                            </div>
